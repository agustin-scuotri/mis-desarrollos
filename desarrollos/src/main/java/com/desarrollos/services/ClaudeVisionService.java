                  ...
                  "messages": [
                    {
                      ...
                      "content": [
                        ...
                        {
                          "type": "text",
                          "text": "Analizá esta factura argentina y extraé los siguientes datos. Respondé ÚNICAMENTE con un JSON con este formato exacto, sin explicaciones ni texto adicional: { \\"cuit\\": \\"valor\\", \\"razonSocial\\": \\"valor\\", \\"situacionIva\\": \\"valor\\", \\"direccion\\": \\"calle + numero + piso + departamento u oficina concatenados en un solo texto\\", \\"ciudad\\": \\"valor\\", \\"codigoPostal\\": \\"valor\\", \\"provincia\\": \\"valor\\", \\"pais\\": \\"valor\\", \\"telefono\\": \\"valor\\", \\"mail\\": \\"valor\\", \\"codigoArca\\": \\"codigo ARCA que aparece debajo de la letra del comprobante (ej: COD 001)\\", \\"letra\\": \\"letra del comprobante (A, B, C, etc.)\\", \\"centroEmision\\": \\"primer bloque numerico del numero de comprobante (punto de venta)\\", \\"numeroComprobante\\": \\"segundo bloque numerico del numero de comprobante\\", \\"fechaEmision\\": \\"fecha de emision del comprobante\\" }. Si algún campo no está presente en el documento, usá null como valor."
                        }
                      ]
                    }
                  ]
